...
The owner of the computer doesn't think it is intentional but he does believe that its the laziness of the company to not address these issues that is a problem.
If yes or no, justify you conclusion.
How do you think this happened?
This probably happened because the coding for the black ascii may interfere with the face recognition
Is this harmful? Was it intended to be harmful or exclude?
This is not harmful physically but it is very frustrating for those who are unable to use those accessories
Should it be corrected?
This should be corrected immediately or else the program doesn't function properly
What would you or should you do to produce a better outcome?
Rewrite the program so that it uses a different indicator of skin color or to include a different code to cover for darker skinned people
